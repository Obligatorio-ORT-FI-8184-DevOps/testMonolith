...
public class ProductsLogic {
    ...
    public ProductsLogic() {
        ...
        testProducts.put("123", new Product("123", "monolith-0.2.8", 10, "Este es un producto"));
        testProducts.put("321", new Product("321", "monolith-0.2.8", 10, "Este es un producto"));
        testProducts.put("111", new Product("111", "monolith-0.2.8", 10, "Este es un producto"));
    }
