...
public class ProductsLogic {
    ...
    public ProductsLogic() {
        ...
        testProducts.put("123", new Product("123", "Producto -*----__123--", 10, "Este es un producto"));
        testProducts.put("321", new Product("321", "Producto -*----__321--", 10, "Este es un producto"));
        testProducts.put("111", new Product("111", "Producto -*----__111--", 10, "Este es un producto"));
    }
